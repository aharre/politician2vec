...
class Politician2Vec:
    ...
    def __init__(self,
        ...
        if embedding_model == 'doc2vec':
            ...
            doc2vec_args = {"vector_size": doc2vec_vector_size,
                            "min_count": min_count,
                            "window": doc2vec_window,
                            "sample": doc2vec_samples_threshold,
                            "negative": negative,
                            "hs": hs,
                            "epochs": epochs,
                            "dm": 0,
    ...
    def _find_party_words_and_scores(self, party_vectors):
        ...
        pt_words = np.flip(np.argsort(res, axis=1), axis=1)
        pt_scores = np.flip(np.sort(res, axis=1), axis=1)
